...
export default function Nav() {
    ...
    <nav className="flex justify-between items-center py-10">
        <Link href="/">
            <button className="text-lg font-medium">Fullstack app</button>
        </Link>
        <ul className="flex items-center gap-10">
            ...
            {user && (
                <div className="flex items-center gap-6">
                    <Link href="/post">
                        <button className="font-medium bg-cyan-500 text-white py-6 px-4 rounded-mg texttx-sm">Post</button>
                    </Link>
                    <Link href="/dashboard">
